  ...
  try {
    const promise1 = transport.sendMail({
      ...
      html: `<h3 style="color: purple; font-size: 30px; font-weight: normal;">Thank you!</h3>
        <p>We apppreciate your interest in ${doesPetExist.name} and one of our staff members will reach out to you shortly! Below is a copy of the message you sent us for your personal records:</p>
